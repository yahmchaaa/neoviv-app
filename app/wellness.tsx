...
const WELLNESS_PACKAGES = [
  {
    ...
    description: 'Post-workout muscle recovery & relaxation',
    price: 349,
    duration: '90 min',
    icon: '💪',
    popular: false,
  ...
  },
  {
    id: 'energy',
    name: 'Energy Revive',
    description: 'Combat fatigue & boost vitality',
    price: 279,
    duration: '60 min',
    icon: '⚡',
    popular: false,
  },
  {
    id: 'detox',
    name: 'Detox Cleanse',
    description: 'Full body detoxification & renewal',
    price: 399,
    duration: '90 min',
    icon: '🌿',
    popular: false,
  },
  {
    id: 'beauty',
    name: 'Beauty Drip',
    description: 'Skin rejuvenation & anti-aging support',
    price: 449,
    duration: '75 min',
    icon: '✨',
    popular: false,
  },
  {
    ...
    description: 'Deep relaxation & sleep quality support',
    price: 259,
    duration: '60 min',
    icon: '🌙',
    popular: false,
